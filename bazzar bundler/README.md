...
`build/app/outputs/bundle/bazaarRelease/app-bazaar-release.aab`
...
1. همان AABی را که با `flutter build appbundle --release --flavor bazaar` ساخته‌اید در پیشخان بازار بارگذاری کنید
